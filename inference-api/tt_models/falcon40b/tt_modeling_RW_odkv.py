        ...
        *past_key_values,
        ...
        for i, block in enumerate(self.layers):
            if len(past_key_values) > 0:
                ...
                layer_past = [
                    layer.view(1, seq_len, user_rows, head_dim).transpose(1, 2)
                    for layer in layer_past_blocked
                ]
            ...
            kvs_reshaped = [
                cache.transpose(1, 2).reshape(1, 1, seq_len, self.head_dim * user_rows)
                for cache in outputs[1:]
            ]
