...
API_URL = f"{API_BASE_URL}/inference/falcon40b"
...
def test_api_load():
    threads = []
    quick_prompts = ["this that those them there"] * 10
    load_prompts = prompts * 3
    ...
    global overloaded_counter
    global fail_counter
    print(f"overloaded_counter:= {overloaded_counter}")
